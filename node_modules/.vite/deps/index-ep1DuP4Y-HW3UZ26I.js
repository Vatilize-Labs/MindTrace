...
// node_modules/.pnpm/@puzzlehq+sdk@0.1.51_@types+react@18.3.31_react-dom@18.3.1_react@18.3.1__typescript@5.9.3_zod@3.21.1/node_modules/@puzzlehq/sdk/dist/index-ep1DuP4Y.js
init_process();
init_buffer();
var import_react = __toESM(require_react(), 1);
var de = window;
var wr2 = de.ShadowRoot && (de.ShadyCSS === void 0 || de.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var vr = Symbol();
var _r = /* @__PURE__ */ new WeakMap();
var no = class {
  constructor(t, r, n) {
    if (this._$cssResult$ = true, n !== vr)
...
var jo = (e) => new no(typeof e == "string" ? e : e + "", void 0, vr);
var M = (e, ...t) => {
...
var Wo = (e, t) => {
  wr2 ? e.adoptedStyleSheets = t.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet) : t.forEach((r) => {
...
var Or = wr2 ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
...
var Ce;
var he = window;
var kr = he.trustedTypes;
var Ho = kr ? kr.emptyScript : "";
var Ir = he.reactiveElementPolyfillSupport;
var sr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ho : null;
      break;
...
var io = (e, t) => t !== e && (t == t || e == e);
var Ee = { attribute: true, type: String, converter: sr, reflect: false, hasChanged: io };
var ar = "finalized";
var $t2 = class extends HTMLElement {
  ...
  requestUpdate(t, r, n) {
    let o = true;
    t !== void 0 && (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || io)(this[t], r) ? (this._$AL.has(t) || this._$AL.set(t, r), n.reflect === true && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, n))) : o = false), !this.isUpdatePending && o && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
$t2[ar] = true, $t2.elementProperties = /* @__PURE__ */ new Map(), $t2.elementStyles = [], $t2.shadowRootOptions = { mode: "open" }, Ir == null || Ir({ ReactiveElement: $t2 }), ((Ce = he.reactiveElementVersions) !== null && Ce !== void 0 ? Ce : he.reactiveElementVersions = []).push("1.6.3");
var Ae;
var ue = window;
var Ot = ue.trustedTypes;
var Tr = Ot ? Ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0;
var lr = "$lit$";
var rt = `lit$${(Math.random() + "").slice(9)}$`;
var so = "?" + rt;
var zo = `<${so}>`;
var ft = document;
var Zt = () => ft.createComment("");
var Vt = (e) => e === null || typeof e != "object" && typeof e != "function";
var ao = Array.isArray;
var Fo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function";
var _e = `[ 	
\f\r]`;
var Rt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var Pr = /-->/g;
var Mr = />/g;
var lt = RegExp(`>|${_e}(?:([^\\s"'>=/]+)(${_e}*=${_e}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var Sr = /'/g;
var Rr = /"/g;
var lo = /^(?:script|style|textarea|title)$/i;
var co = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r });
var m = co(1);
var L = co(2);
var pt = Symbol.for("lit-noChange");
var B = Symbol.for("lit-nothing");
var Lr = /* @__PURE__ */ new WeakMap();
var ut = ft.createTreeWalker(ft, 129, null, false);
function ho(e, t) {
...
var Kt = class _Kt {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    if (this.el = _Kt.createElement(c, n), ut.currentNode = this.el.content, r === 2) {
          ...
          for (const h of o.getAttributeNames())
            if (h.endsWith(lr) || h.startsWith(rt)) {
              ...
              if (b.push(h), u !== void 0) {
                ...
                l.push({ type: 1, index: i, name: g[2], strings: p, ctor: g[1] === "." ? Ko : g[1] === "?" ? Yo2 : g[1] === "@" ? Jo : ve });
              } else
...
function kt(e, t, r = e, n) {
  ...
  return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, false), c === void 0 ? l = void 0 : (l = new c(e), l._$AT(e, r, n)), n !== void 0 ? ((s = (a = r)._$Co) !== null && s !== void 0 ? s : a._$Co = [])[n] = l : r._$Cl = l), l !== void 0 && (t = kt(e, l._$AS(e, t.values), l, n)), t;
}
var Vo = class {
  constructor(t, r) {
  ...
  u(t) {
    var r;
    const { el: { content: n }, parts: o } = this._$AD, i = ((r = t == null ? void 0 : t.creationScope) !== null && r !== void 0 ? r : ft).importNode(n, true);
    ut.currentNode = i;
...
var Jt = class _Jt {
  ...
  T(t) {
    ...
    let n, o = 0;
    for (const i of t)
      o === r.length ? r.push(n = new _Jt(this.k(Zt()), this.k(Zt()), this, this.options)) : n = r[o], n._$AI(i), o++;
...
var qo = Ot ? Ot.emptyScript : "";
var Yo2 = class extends ve {
  constructor() {
...
var Nr = ue.litHtmlPolyfillSupport;
...
A.finalized = true, A._$litElement$ = true, (Oe = globalThis.litElementHydrateSupport) === null || Oe === void 0 || Oe.call(globalThis, { LitElement: A });
...
var O = (e) => (t) => typeof t == "function" ? ((r, n) => (customElements.define(r, n), n))(e, t) : ((r, n) => {
  const { kind: o, elements: i } = n;
  return { kind: o, elements: i, finisher(s) {
    customElements.define(r, s);
  } };
})(e, t);
var Xo = (e, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(r) {
...
function j(e) {
  return C({ ...e, state: true });
}
var Ie;
((Ie = window.HTMLSlotElement) === null || Ie === void 0 ? void 0 : Ie.prototype.assignedElements) != null;
var en = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 };
var rn = (e) => (...t) => ({ _$litDirective$: e, values: t });
var on = class {
  constructor(t) {
  }
  get _$AU() {
...
var uo = (e, t, r) => Math.min(Math.max(r, e), t);
var H = {
  duration: 0.3,
  delay: 0,
  endDelay: 0,
...
var Et = (e) => Array.isArray(e) && !me(e[0]);
var sn = (e, t, r) => {
  const n = t - e;
  return ((r - e) % n + n) % n + e;
};
...
var mo = (e, t, r) => -r * e + r * t + e;
var go = () => {
};
var it = (e) => e;
var br = (e, t, r) => t - e === 0 ? 1 : (r - e) / (t - e);
function fo(e, t) {
...
var po = (e) => Array.isArray(e) && me(e[0]);
var cr = (e) => typeof e == "object" && !!e.createAnimation;
...
var wo = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e;
var hn = 1e-7;
var un = 12;
...
var vn = ["", "X", "Y", "Z"];
var bn = ["translate", "scale", "rotate", "skew"];
var ge = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
...
var xn = (e, t) => fe.indexOf(e) - fe.indexOf(t);
var $n = new Set(fe);
var yo = (e) => $n.has(e);
var Cn = (e, t) => {
  ge[t] && (t = ge[t]);
...
var En = (e) => e.sort(xn).reduce(An, "").trim();
var An = (e, t) => `${e} ${t}(var(${yr(t)}))`;
var hr = (e) => e.startsWith("--");
...
var Pe = (e, t) => document.createElement("div").animate(e, t);
var Hr = {
...
var zr = (e, t) => It(e) ? Ct.linearEasing() ? `linear(${kn(e, t)})` : H.easing : po(e) ? In(e) : e;
var In = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`;
function Tn(e, t) {
...
function Rn(e, t, r, n = {}, o) {
  const i = Sn(), s = n.record !== false && i;
  let a, { duration: l = H.duration, delay: c = H.delay, endDelay: d = H.endDelay, repeat: b = H.repeat, easing: h = H.easing, persist: u = false, direction: p, offset: g, allowWebkitAcceleration: $ = false } = n;
  const f = bo(e), y = yo(t);
  let v = Ct.waapi();
  y && Cn(e, t);
  const w = ur(t), k = wn(f.values, w), I = qt.get(w);
  return xo(k.animation, !(cr(h) && k.generator) && n.record !== false), () => {
    const R = () => {
      var P, F;
    ...
    if (hr(w) && (Ct.cssRegisterProperty() ? _n(w) : v = false), y && !Ct.linearEasing() && (It(h) || Et(h) && h.some(It)) && (v = false), v) {
...
var Bn = (e) => e();
var $o = (e, t, r = H.duration) => new Proxy({
  animations: e.map(Bn).filter(Boolean),
  duration: r,
  options: t
}, Un);
var Dn = (e) => e.animations[0];
var Un = {
  get: (e, t) => {
    const r = Dn(e);
    switch (t) {
...
var ko = {};
var xe = {};
var Ft = new Uint8Array(512);
var pe = new Uint8Array(256);
(function() {
  let t = 1;
  for (let r = 0; r < 255; r++)
...
var Po = "[0-9]+";
var Gn = "[A-Z $%*+\\-./:]+";
var Yt = "(?:[u3000-u303F]|[u3040-u309F]|[u30A0-u30FF]|[uFF00-uFFEF]|[u4E00-u9FAF]|[u2605-u2606]|[u2190-u2195]|u203B|[u2010u2015u2018u2019u2025u2026u201Cu201Du2225u2260]|[u0391-u0451]|[u00A7u00A8u00B1u00B4u00D7u00F7])+";
Yt = Yt.replace(/u/g, "\\u");
var Qn = "(?:(?![A-Z0-9 $%*+\\-./:]|" + Yt + `)(?:.|[\r
]))+`;
...
var Xn = new RegExp("^" + Yt + "$");
var ti = new RegExp("^" + Po + "$");
var ei = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function $i(e, t) {
  ...
  for (let o = 0; o < n.length; o++) {
    ...
    for (let a = -1; a <= 7; a++)
      if (!(i + a <= -1 || r <= i + a))
        for (let l = -1; l <= 7; l++)
          s + l <= -1 || r <= s + l || (a >= 0 && a <= 6 && (l === 0 || l === 6) || l >= 0 && l <= 6 && (a === 0 || a === 6) || a >= 2 && a <= 4 && l >= 2 && l <= 4 ? e.set(i + a, s + l, true, true) : e.set(i + a, s + l, false, true));
  }
}
function Ci(e) {
  const t = e.size;
...
function Ei(e, t) {
  ...
  for (let n = 0; n < r.length; n++) {
    ...
    for (let s = -2; s <= 2; s++)
      for (let a = -2; a <= 2; a++)
        s === -2 || s === 2 || a === -2 || a === 2 || s === 0 && a === 0 ? e.set(o + s, i + a, true, true) : e.set(o + s, i + a, false, true);
  }
}
function Ai(e, t) {
  ...
  let o, i, s;
  for (let a = 0; a < 18; a++)
    o = Math.floor(a / 3), i = a % 3 + r - 8 - 3, s = (n >> a & 1) === 1, e.set(o, i, s, true), e.set(i, o, s, true);
}
function Ne(e, t, r) {
  const n = e.size, o = yi.getEncodedBits(t, r);
  let i, s;
  for (i = 0; i < 15; i++)
    s = (o >> i & 1) === 1, i < 6 ? e.set(i, 8, s, true) : i < 8 ? e.set(i + 1, 8, s, true) : e.set(n - 15 + i, 8, s, true), i < 8 ? e.set(8, n - i - 1, s, true) : i < 9 ? e.set(8, 15 - i - 1 + 1, s, true) : e.set(8, 15 - i - 1, s, true);
  e.set(n - 8, 8, 1, true);
}
function _i(e, t) {
  const r = e.size;
...
function Pi(e, t, r) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    !l && !i && (i = true), e[a] ? (s++, a > 0 && l > 0 && e[a - 1] || (n += i ? Be("M", l + r, 0.5 + c + r) : Be("m", o, 0), o = 0, i = false), l + 1 < t && e[a + 1] || (n += Be("h", s), s = 0)) : o++;
  }
  return n;
}
...
var qr = (e, t, r) => t in e ? Ri(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r;
var De = (e, t) => {
  for (var r in t || (t = {}))
...
function Bi() {
  var e;
  const t = (e = Eu.state.themeMode) != null ? e : "dark", r = { light: { foreground: { 1: "rgb(20,20,20)", 2: "rgb(121,134,134)", 3: "rgb(158,169,169)" }, background: { 1: "rgb(255,255,255)", 2: "rgb(241,243,243)", 3: "rgb(228,231,231)" }, overlay: "rgba(0,0,0,0.1)" }, dark: { foreground: { 1: "rgb(228,231,231)", 2: "rgb(148,158,158)", 3: "rgb(110,119,119)" }, background: { 1: "rgb(20,20,20)", 2: "rgb(39,42,42)", 3: "rgb(59,64,64)" }, overlay: "rgba(255,255,255,0.1)" } }[t];
...
var _ = { getPreset(e) {
  ...
  const e = document.querySelector(":root"), { themeVariables: t } = Eu.state;
  if (e) {
...
var Di = M`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
...
var Wi = M`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
...
var Fi = M`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
...
var We = class extends A {
  render() {
    return m`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${S.WALLET_CONNECT_LOGO} <button @click="${Yo.close}">${S.CROSS_ICON}</button></div>`;
  }
};
We.styles = [_.globalCss, qi], We = Gi([O("wcm-modal-backcard")], We);
var Qi = M`main{padding:20px;padding-top:0;width:100%}`;
...
var rs = M`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
...
var ct = class extends A {
  ...
  backBtnTemplate() {
    return m`<button class="wcm-back-btn" @click="${Mf.goBack}">${S.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
    return m`<button class="wcm-action-btn" @click="${this.onAction}">${this.actionIcon}</button>`;
  }
  render() {
    const e = { "wcm-border": this.border }, t = Mf.state.history.length > 1, r = this.title ? m`<wcm-text variant="big-bold">${this.title}</wcm-text>` : m`<slot></slot>`;
...
var x = { MOBILE_BREAKPOINT: 600, WCM_RECENT_WALLET_DATA: "WCM_RECENT_WALLET_DATA", EXPLORER_WALLET_URL: "https://explorer.walletconnect.com/?type=wallet", getShadowRootElement(e, t) {
  const r = e.renderRoot.querySelector(t);
  if (!r)
    throw new Error(`${t} not found`);
  return r;
}, getWalletIcon({ id: e, image_id: t }) {
  const { walletImages: r } = as.state;
  return r != null && r[e] ? r[e] : t ? kO.getWalletImageUrl(t) : "";
  ...
  return Promise.race([t, $t.wait(3e3)]);
}, getErrorMessage(e) {
  ...
  const { walletConnectUri: t } = wr.state, { mobile: r, name: n } = e, o = r == null ? void 0 : r.native, i = r == null ? void 0 : r.universal;
  x.setRecentWallet(e);
  function s(a) {
    let l = "";
    o ? l = $t.formatUniversalUrl(o, a, n) : i && (l = $t.formatNativeUrl(i, a, n)), $t.openHref(l, "_self");
  }
  t && s(t);
}, handleAndroidLinking() {
  const { walletConnectUri: e } = wr.state;
  e && ($t.setWalletConnectAndroidDeepLink(e), $t.openHref(e, "_self"));
}, async handleUriCopy() {
  const { walletConnectUri: e } = wr.state;
  if (e)
    try {
      await navigator.clipboard.writeText(e), qO.openToast("Link copied", "success");
    } catch {
      qO.openToast("Failed to copy", "error");
    }
}, getCustomImageUrls() {
  const { walletImages: e } = as.state, t = Object.values(e ?? {});
  ...
  $t.openHref(x.EXPLORER_WALLET_URL, "_blank");
}, getCachedRouterWalletPlatforms() {
  const { desktop: e, mobile: t } = $t.getWalletRouterData(), r = !!(e != null && e.native), n = !!(e != null && e.universal), o = !!(t != null && t.native) || !!(t != null && t.universal);
  return { isDesktop: r, isMobile: o, isWeb: n };
}, goToConnectingView(e) {
  Mf.setData({ Wallet: e });
  const t = $t.isMobile(), { isDesktop: r, isWeb: n, isMobile: o } = x.getCachedRouterWalletPlatforms();
  t ? o ? Mf.push("MobileConnecting") : n ? Mf.push("WebConnecting") : Mf.push("InstallWallet") : r ? Mf.push("DesktopConnecting") : n ? Mf.push("WebConnecting") : o ? Mf.push("MobileQrcodeConnecting") : Mf.push("InstallWallet");
} };
var cs = M`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
...
var Bt = class extends A {
  constructor() {
    super(), this.view = Mf.state.view, this.prevView = Mf.state.view, this.unsubscribe = void 0, this.oldHeight = "0px", this.resizeObserver = void 0, this.unsubscribe = Mf.subscribe((e) => {
  ...
  async onChangeRoute() {
    await mt(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = Mf.state.view, mt(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
...
var us = M`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
...
var re = class extends A {
  constructor() {
    super(), this.open = false, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = qO.subscribe((e) => {
      e.open ? (this.open = true, this.timeout = setTimeout(() => qO.closeToast(), 2200)) : (this.open = false, clearTimeout(this.timeout));
    });
  }
  disconnectedCallback() {
    var e;
    (e = this.unsubscribe) == null || e.call(this), clearTimeout(this.timeout), qO.closeToast();
  }
  render() {
    const { message: e, variant: t } = qO.state, r = { "wcm-success": t === "success", "wcm-error": t === "error" };
...
var J = 7;
function Ze(e, t, r) {
  return e === t ? false : (e - t < 0 ? t - e : e - t) <= r + fs;
}
function ps(e, t) {
...
var X = class extends A {
  ...
  svgTemplate() {
    const e = Eu.state.themeMode === "light" ? this.size : this.size - 36;
    return L`<svg height="${e}" width="${e}">${ws.generate(this.uri, e, e / 4)}</svg>`;
  }
  render() {
    const e = { "wcm-dark": Eu.state.themeMode === "dark" };
...
var Es = M`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
...
var Ps = M`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
var Ms = Object.defineProperty;
...
var K = class extends A {
  ...
  handleClick() {
    Mp.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e;
    return m`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${D(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(e = this.label) != null ? e : x.getWalletName(this.name, true)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
...
var Rs = M`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
var qe = class extends A {
  ...
  async preloadListings() {
    if (as.state.enableExplorer) {
      await kO.getRecomendedWallets(), wr.setIsDataLoaded(true);
      const { recomendedWallets: e } = kO.state, t = e.map((r) => x.getWalletIcon(r));
      await this.loadImages(t);
    } else
      wr.setIsDataLoaded(true);
  }
  ...
  async preloadData() {
    try {
      ...
      console.error(e), qO.openToast("Failed preloading", "error");
    }
  }
};
...
var to = class extends A {
  constructor() {
    super(), this.unsubscribeTheme = void 0, _.setTheme(), this.unsubscribeTheme = Eu.subscribe(_.setTheme);
  }
  disconnectedCallback() {
    var e;
...
var Ye = class extends A {
  ...
  render() {
    const { recomendedWallets: e } = kO.state, t = [...e, ...e], r = $t.RECOMMENDED_WALLET_AMOUNT * 2;
...
var et = class extends A {
  ...
  svgLoaderTemplate() {
    var e, t;
    const r = (t = (e = Eu.state.themeVariables) == null ? void 0 : e["--wcm-wallet-icon-large-border-radius"]) != null ? t : _.getPreset("--wcm-wallet-icon-large-border-radius");
    let n = 0;
...
var At = { manualWallets() {
  var e, t;
  const { mobileWallets: r, desktopWallets: n } = as.state, o = (e = At.recentWallet()) == null ? void 0 : e.id, i = $t.isMobile() ? r : n, s = i == null ? void 0 : i.filter((a) => o !== a.id);
  return (t = $t.isMobile() ? s == null ? void 0 : s.map(({ id: a, name: l, links: c }) => ({ id: a, name: l, mobile: c, links: c })) : s == null ? void 0 : s.map(({ id: a, name: l, links: c }) => ({ id: a, name: l, desktop: c, links: c }))) != null ? t : [];
}, recentWallet() {
  return x.getRecentWallet();
}, recomendedWallets(e = false) {
  var t;
  const r = e || (t = At.recentWallet()) == null ? void 0 : t.id, { recomendedWallets: n } = kO.state;
  return n.filter((o) => r !== o.id);
} };
var st = { onConnecting(e) {
  ...
  if (e)
    return m`<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${D(e.image_id)}" .recent="${true}" .onClick="${() => this.onConnecting(e)}"></wcm-wallet-button>`;
} };
var Ys = M`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
...
var Je = class extends A {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: t } = as.state, r = e !== "ALL" && t, n = st.manualWalletsTemplate(), o = st.recomendedWalletsTemplate();
...
var Ge = class extends A {
  render() {
    const { termsOfServiceUrl: e, privacyPolicyUrl: t } = as.state;
...
var oa = M`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
...
var Ut = class extends A {
  constructor() {
    super(), this.open = false, this.active = false, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = Yo.subscribe((e) => {
  ...
  onCloseModal(e) {
    e.target === e.currentTarget && Yo.close();
  }
  onOpenModalEvent() {
    this.toggleBodyScroll(false), this.addKeyboardEvents(), this.open = true, setTimeout(async () => {
      ...
      await Promise.all([mt(this.overlayEl, { opacity: [0, 1] }, { delay: t, duration: r }).finished, mt(this.containerEl, e, { delay: t, duration: r }).finished]), this.active = true;
    }, 0);
  }
  async onCloseModalEvent() {
    this.toggleBodyScroll(true), this.removeKeyboardEvents();
    const e = x.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] }, t = 0.2;
    await Promise.all([mt(this.overlayEl, { opacity: [1, 0] }, { duration: t }).finished, mt(this.containerEl, e, { duration: t }).finished]), this.containerEl.removeAttribute("style"), this.active = false, this.open = false;
  }
  addKeyboardEvents() {
    this.abortController = new AbortController(), window.addEventListener("keydown", (e) => {
      var t;
      e.key === "Escape" ? Yo.close() : e.key === "Tab" && ((t = e.target) != null && t.tagName.includes("wcm-") || this.containerEl.focus());
...
var da = M`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
var dt = class extends A {
  ...
  onMobile() {
    $t.isMobile() ? Mf.replace("MobileConnecting") : Mf.replace("MobileQrcodeConnecting");
  }
  onDesktop() {
    Mf.replace("DesktopConnecting");
  }
  onWeb() {
    Mf.replace("WebConnecting");
  }
  render() {
...
var ma = M`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
var tr = class extends A {
  onClick() {
    Mf.push("WalletExplorer");
  }
  render() {
    const { recomendedWallets: e } = kO.state, t = At.manualWallets(), r = [...e, ...t].reverse().slice(0, 4);
...
var wa = M`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
var er = class extends A {
  viewTemplate() {
    return $t.isAndroid() ? m`<wcm-android-wallet-selection></wcm-android-wallet-selection>` : $t.isMobile() ? m`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>` : m`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  render() {
...
var Ca = M`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
var se = class extends A {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: r } = $t.getWalletRouterData(), n = t == null ? void 0 : t.native;
    if (n) {
      const o = $t.formatNativeUrl(n, e, r);
      $t.openHref(o, "_self");
    }
  }
  openDesktopApp() {
    const { walletConnectUri: e } = wr.state, t = $t.getWalletRouterData();
    x.setRecentWallet(t), e && this.onFormatAndRedirect(e);
  }
  render() {
    const { name: e, id: t, image_id: r } = $t.getWalletRouterData(), { isMobile: n, isWeb: o } = x.getCachedRouterWalletPlatforms();
    return m`<wcm-modal-header title="${e}" .onAction="${x.handleUriCopy}" .actionIcon="${S.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${e} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${n}" .isWeb="${o}" .isRetry="${true}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${S.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
se.styles = [_.globalCss, Ca], eo([j()], se.prototype, "isError", 2), se = eo([O("wcm-desktop-connecting-view")], se);
var _a = M`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
...
var rr = class extends A {
  onInstall(e) {
    e && $t.openHref(e, "_blank");
  }
  render() {
    const { name: e, id: t, image_id: r, homepage: n } = $t.getWalletRouterData();
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="Not Detected" .isStale="${true}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Download ${e} to continue. If multiple browser extensions are installed, disable non ${e} ones and try again`}</wcm-text><wcm-button .onClick="${() => this.onInstall(n)}" .iconLeft="${S.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`;
  }
};
rr.styles = [_.globalCss, _a], rr = Ia([O("wcm-install-wallet-view")], rr);
var Ta = M`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
...
var ae = class extends A {
  ...
  onFormatAndRedirect(e, t = false) {
    const { mobile: r, name: n } = $t.getWalletRouterData(), o = r == null ? void 0 : r.native, i = r == null ? void 0 : r.universal;
    if (o && !t) {
      const s = $t.formatNativeUrl(o, e, n);
      $t.openHref(s, "_self");
    } else if (i) {
      const s = $t.formatUniversalUrl(i, e, n);
      $t.openHref(s, "_self");
    }
  }
  openMobileApp(e = false) {
    const { walletConnectUri: t } = wr.state, r = $t.getWalletRouterData();
  ...
  render() {
    const { name: e, id: t, image_id: r, app: n, mobile: o } = $t.getWalletRouterData(), { isWeb: i } = x.getCachedRouterWalletPlatforms(), s = n == null ? void 0 : n.ios, a = o == null ? void 0 : o.universal;
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${i}" .isRetry="${true}"><wcm-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${S.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${a ? m`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(true)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${D(r)}"></wcm-wallet-image><wcm-text>${`Get ${e}`}</wcm-text></div><wcm-button .iconRight="${S.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(s)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
ae.styles = [_.globalCss, Ta], ro([j()], ae.prototype, "isError", 2), ae = ro([O("wcm-mobile-connecting-view")], ae);
var Sa = M`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
var or = class extends A {
  render() {
    const { name: e, id: t, image_id: r } = $t.getWalletRouterData(), { isDesktop: n, isWeb: o } = x.getCachedRouterWalletPlatforms();
...
var ja = M`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
...
var ht = class extends A {
  constructor() {
    super(...arguments), this.loading = !kO.state.wallets.listings.length, this.firstFetch = !kO.state.wallets.listings.length, this.search = "", this.endReached = false, this.intersectionObserver = void 0, this.searchDebounce = x.debounce((e) => {
      e.length >= 1 ? (this.firstFetch = true, this.endReached = false, this.search = e, kO.resetSearch(), this.fetchWallets()) : this.search && (this.search = "", this.endReached = this.isLastPage(), kO.resetSearch());
    });
  }
  firstUpdated() {
  ...
  isLastPage() {
    const { wallets: e, search: t } = kO.state, { listings: r, total: n } = this.search ? t : e;
    return n <= ir || r.length >= n;
  }
  async fetchWallets() {
    var e;
    const { wallets: t, search: r } = kO.state, { listings: n, total: o, page: i } = this.search ? r : t;
    if (!this.endReached && (this.firstFetch || o > ir && n.length < o))
      try {
        this.loading = true;
        const s = (e = wr.state.chains) == null ? void 0 : e.join(","), { listings: a } = await kO.getWallets({ page: this.firstFetch ? 1 : i + 1, entries: ir, search: this.search, version: 2, chains: s }), l = a.map((c) => x.getWalletIcon(c));
        await Promise.all([...l.map(async (c) => x.preloadImage(c)), $t.wait(300)]), this.endReached = this.isLastPage();
      } catch (s) {
        console.error(s), qO.openToast(x.getErrorMessage(s), "error");
      } finally {
        this.loading = false, this.firstFetch = false;
      }
  }
  onConnect(e) {
    $t.isAndroid() ? x.handleMobileLinking(e) : x.goToConnectingView(e);
  }
  onSearchChange(e) {
  ...
  render() {
    const { wallets: e, search: t } = kO.state, { listings: r } = this.search ? t : e, n = this.loading && !r.length, o = this.search.length >= 3;
    let i = st.manualWalletsTemplate(), s = st.recomendedWalletsTemplate(true);
...
var za = M`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
var le = class extends A {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: r } = $t.getWalletRouterData(), n = t == null ? void 0 : t.universal;
    if (n) {
      const o = $t.formatUniversalUrl(n, e, r);
      $t.openHref(o, "_blank");
    }
  }
  openWebWallet() {
  ...
  render() {
    const { name: e, id: t, image_id: r } = $t.getWalletRouterData(), { isMobile: n, isDesktop: o } = x.getCachedRouterWalletPlatforms(), i = $t.isMobile();
    return m`<wcm-modal-header title="${e}" .onAction="${x.handleUriCopy}" .actionIcon="${S.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(r)}" label="${`Continue in ${e}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`${e} web app has opened in a new tab. Go there, accept the connection, and come back`}</wcm-text><wcm-platform-selection .isMobile="${n}" .isDesktop="${i ? false : o}" .isRetry="${true}"><wcm-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${S.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
...
@puzzlehq/sdk/dist/index-ep1DuP4Y.js:
  (**
   * @license
   ...
   *)
*/
//# sourceMappingURL=index-ep1DuP4Y-HW3UZ26I.js.map
